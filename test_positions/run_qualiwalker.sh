...
INPUT_FILES="1168_A_merged_dedup_realign_STXBP6_region.bam"
...
for f in $INPUT_FILES; do 
		...
		function quali_walk { c=$1;  python ../PositionWalker.py -f $REF_GENOME -r $c -s $KNOWN_SNP -o ${sample_name}_${c}_qual_positions.txt $FF; }
